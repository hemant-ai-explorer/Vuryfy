...
export async function POST(request: Request) {
  ...
  track(user.id, "verification_submitted", { mode: "quick", input_type: "image" });
  ...
  try {
    ...
    track(user.id, "verification_failed", { mode: "quick", input_type: "image", reason: "infra_error" });
