...
export async function POST(request: Request) {
  ...
  track(user.id, "verification_submitted", { mode: "quick", input_type: "audio_combined" });
  ...
  try {
    ...
    track(user.id, "verification_failed", { mode: "quick", input_type: "audio_combined", reason: "infra_error" });
